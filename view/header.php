...
<?php elseif (isset($_GET['error-msg'])): ?>
...
<div class="container">
    ...
    <script>
        ...
        $(function () {
            ...
            buildLanguageSelect(selectSite, "siteLanguage");
            ...
            <div class="modal-content cf1">
                ...
                <div class="modal-body">
                    ...
                    <form class="cf1" action="../controller/user_controller.php" method="post">
                        ...
                        <input name="email" type="email" id="loginEmail" placeholder="<?= $lang['email'] ?>" required autofocus/>

                        <input name="password" type="password" placeholder="<?= $lang['password'] ?>" required/>

                        <button type="submit" value="Connexion"><?= $lang['connection'] ?></button>
